...
function troll() {
    ...
    const y = document.getElementById("fbut3");
      ...
      document.getElementById("alert2").innerHTML = "No puedes irte sin leer todo 😛";
      document.getElementById("audio2").play();
      return false;
}
function troll1() {
...
function inrel() {
    ...
    const b = document.getElementById("fbut2alt");
     ...
     c.innerHTML = "";
     c.innerHTML = "Feliz dia mujer, por que En tu mirada encuentro el universo entero reflejado, lleno de estrellas que brillan con la intensidad de tu alma =))";
     y.style.display="none";
     x.style.display="inline";
     document.getElementById("audio3").play();
     document.getElementById("alert2").innerHTML = "";
     document.getElementById("des").innerHTML = "En este día especial, quiero agradecerte por tu amistad incondicional y por ser esa fuente constante de inspiración y cariño en mi vida😳";
     return false;
...
function trollalt() {
    document.getElementById("alert2").innerHTML="A donde sigue leyendo, loquita :_V";
    alert("jaja no podras salir ");
    return false;
}
